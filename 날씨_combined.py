...
# 원래 값을 저장
original_fc_year = train_data[fc_year].unique()
original_ef_year = train_data[ef_year].unique()
original_stn4contest = train_data[stn4contest].unique()
...
for name, estimator in best_estimators.items():
    ...
    # 모델 저장
    joblib.dump(estimator, f'{name}_model.pkl')
